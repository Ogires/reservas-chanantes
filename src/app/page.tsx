    ...
    <div className="min-h-screen">
      ...
      <nav className="mx-auto flex max-w-6xl items-center justify-between px-6 py-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <Link
            href="/admin/register"
            className="rounded-lg bg-coral px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-coral-dark transition-colors"
          >
            Get Started
          </Link>
        </div>
      ...
      >
        <div className="grid items-center gap-12 md:grid-cols-2">
          {/* Left */}
          <div>
            <h1 className="font-serif text-5xl font-bold tracking-tight text-slate-900 leading-[1.1]">
              Online bookings,{' '}
            ...
            <Link
              href="/admin/register"
              className="mt-8 inline-flex items-center gap-2 rounded-lg bg-coral px-6 py-3 text-base font-medium text-white shadow-sm hover:bg-coral-dark transition-colors"
            >
              Get Started Free
          ...
          <div className="hidden md:block">
            <div className="rounded-2xl border border-warm-border bg-white p-6 shadow-lg">
              ...
              <div className="space-y-3">
                <div className="rounded-xl border-2 border-teal-500 bg-teal-50/50 p-4">
                  <p className="font-medium text-slate-900">Haircut</p>
                  <p className="text-sm text-slate-500">30 min &middot; 15,00&nbsp;&euro;</p>
                </div>
                <div className="rounded-xl border-2 border-warm-border p-4">
      ...
      <section className="mx-auto max-w-6xl px-6 pb-24">
        <div className="grid gap-8 sm:grid-cols-3">
          {[
            ...
            <div key={f.title} className="rounded-xl border border-warm-border bg-white p-6 shadow-sm">
