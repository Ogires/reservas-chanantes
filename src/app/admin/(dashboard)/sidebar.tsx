...
export function Sidebar({ tenant, setupStatus }: { tenant: Tenant; setupStatus: SetupStatus }) {
  const pathname = usePathname()

  function showBadge(badgeKey: 'hasServices' | 'hasSchedule' | null): boolean {
