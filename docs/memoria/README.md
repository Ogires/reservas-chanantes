...
| 6 | **[Estrategia de Pruebas y Control de Calidad](06-pruebas-calidad.md)** | Pirámide de 240 pruebas, TDD, análisis estático y limitaciones del marco de calidad |
...
| — | **[Anexos](09-anexos.md)** | A. Diccionario de datos · B. Políticas RLS · C. Historial de migraciones · D. Variables de entorno · E. Evaluación OWASP Top 10 · F. Estrategia de pruebas y cobertura |
...
| **Pruebas** | 240 casos en 32 ficheros (Vitest); cobertura con umbral, CI y E2E (Playwright) |
