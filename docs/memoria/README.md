...
| 6 | **[Estrategia de Pruebas y Control de Calidad](06-pruebas-calidad.md)** | Pirámide de 202 pruebas, TDD, análisis estático y limitaciones del marco de calidad |
...
| **Pruebas** | 202 casos en 23 ficheros (Vitest); 85 % en dominio y aplicación |
