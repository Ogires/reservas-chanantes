...
| 6 | **[Estrategia de Pruebas y Control de Calidad](06-pruebas-calidad.md)** | Pirámide de 279 pruebas, TDD, análisis estático y limitaciones del marco de calidad |
...
| **Pruebas** | 279 casos en 41 ficheros (Vitest); cobertura con umbral, CI y E2E (Playwright) |
